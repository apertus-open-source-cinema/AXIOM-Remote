...
static uint16_t page_itemframebuffer_width;
...
void draw_page_item(uint8_t screen_index) {
    ...
    if (screen_index == 1) {
        x = padding_side + padding_elements + page_itemframebuffer_width;
        y = _height - page_item_height;
    }
    if (screen_index == 2) {
        x = padding_side + 2 * padding_elements + 2 * page_itemframebuffer_width;
        y = _height - page_item_height;
    }
    if (screen_index == 3) {
        x = padding_side;
    ...
    if (screen_index < 3) {
        ...
        if (main_page[PAGE_HOME].page_item[screen_index].item_type == BUTTON) {
            //fill_round_rect(x, y + 2 + _button_height, page_itemframebuffer_width, _button_height, 3, page_item_label_background_color);
            //draw_string(x, y + 9 + _button_height, main_page[PAGE_HOME].page_item[screen_index].label,
            //        page_item_label_color, page_item_label_color,
            //        _FreeSans12pt7b, TEXT_ALIGN_CENTER, page_itemframebuffer_width);
        }
        if (main_page[PAGE_HOME].page_item[screen_index].item_type == VALUE_AND_LABEL) {
            // draw label
            fill_round_rect(x, y + page_item_value_height, page_itemframebuffer_width, page_item_label_height, 3,
                    page_item_label_background_color);
            fill_rect(x, y + page_item_value_height, page_itemframebuffer_width, 3, 3, page_item_label_background_color);
            draw_string(x, y + page_item_value_height + 7, main_page[PAGE_HOME].page_item[screen_index].label,
                    ...
                    _FreeSans9pt7b, TEXT_ALIGN_CENTER, page_itemframebuffer_width);

            // draw value
            fill_round_rect(x, y, page_itemframebuffer_width, page_item_value_height, 3, page_item_value_background_color);
            fill_rect(x, y + page_item_value_height - 3, page_itemframebuffer_width, 3, page_item_value_background_color);
        ...
        if (main_page[PAGE_HOME].page_item[screen_index].item_type == BUTTON) {
            //fill_round_rect(x, y + 2, page_itemframebuffer_width, _button_height, 3, page_item_label_background_color);
        ...
        if (main_page[PAGE_HOME].page_item[screen_index].item_type == VALUE_AND_LABEL) {
            ...
            fill_round_rect(x, y + 1, page_itemframebuffer_width, page_item_label_height, 3, page_item_label_background_color);
            fill_rect(x, y + page_item_label_height - 3, page_itemframebuffer_width, 3, 3, page_item_label_background_color);
            draw_string(x, y + 7, main_page[PAGE_HOME].page_item[screen_index].label, page_item_label_color, page_item_label_color,
                    _FreeSans9pt7b, TEXT_ALIGN_CENTER, page_itemframebuffer_width);

            // draw value
            fill_round_rect(x, y + page_item_label_height, page_itemframebuffer_width, page_item_value_height, 3, page_item_value_background_color);
            fill_rect(x, y + page_item_label_height, page_itemframebuffer_width, 3, page_item_value_background_color);
...
void draw_page() {
    //clear the screen
    fill_rect(0, 0, FRAMEBUFFER_WIDTH, _height, page_background_color);
...
//    }
     ...
     * 
     * draw_string(15, 60, "test", page_item_label_color, page_item_label_color, _FreeSans9pt7b, align_left, 0);
    fill_rect(15, 55, get_stringframebuffer_width("test", _FreeSans9pt7b), 3, page_item_value_color);

    draw_string(15, 80, "15", page_item_label_color, page_item_label_color, _FreeSans18pt7b, align_left, 0);
    fill_rect(15, 75, get_stringframebuffer_width("15", _FreeSans18pt7b), 3, page_item_value_color);

    draw_string(15, 110, "A Word", page_item_label_color, page_item_label_color, _FreeSans18pt7b, align_left, 0);
    fill_rect(15, 105, get_stringframebuffer_width("A Word", _FreeSans18pt7b), 3, page_item_value_color);

    draw_string(15, 160, "Long 34", page_item_label_color, page_item_label_color, _FreeSans12pt7b, align_left, 0);
    fill_rect(15, 155, get_stringframebuffer_width("Long 34", _FreeSans12pt7b), 3, page_item_value_color);
     */
}
